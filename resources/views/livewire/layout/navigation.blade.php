...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('channels.index')" :active="request()->routeIs('channels.index')" wire:navigate>
                        {{ __('Channels') }}
                    </x-nav-link>

                    <x-nav-link :href="route('threads.index')" :active="request()->routeIs('threads.index')" wire:navigate>
                        {{ __('Threads') }}
                    </x-nav-link>

                    @auth
                        <x-nav-link :href="route('threads.create')" :active="request()->routeIs('threads.create')" wire:navigate>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('channels.index')" :active="request()->routeIs('channels.index')" wire:navigate>
                {{ __('Channels') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('threads.index')" :active="request()->routeIs('threads.index')" wire:navigate>
                {{ __('Threads') }}
            </x-responsive-nav-link>

            @auth
                <x-responsive-nav-link :href="route('threads.create')" :active="request()->routeIs('threads.create')" wire:navigate>
                    {{ __('Create new Thread') }}
                </x-responsive-nav-link>
            @endauth
